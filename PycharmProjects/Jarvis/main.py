...
openai.api_key = "[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]"
...
def listen_for_wake_word(audio):
    ...
    if BING_WAKE_WORD in text_input.lower().strip():
        print("Speak your prompt to Siri.")
        speak('Listening')
...
def prompt_bing(audio):
    ...
    try:
        ...
        if len(prompt_text.strip()) == 0:
            ...
            speak(str(output))
            print('\nSay Ok Siri or Ok Jarvis to wake me up. \n')
            bing_engine = True
            listening_for_wake_word = True
...
def start_listening():
    ...
    print('\nSay Ok Bing or Ok Jarvis to wake me up. \n')
